## These two functions create and mantain a special object to store a matrix and
## cache its inverse. In addition, there is another function to calculate the inverse
